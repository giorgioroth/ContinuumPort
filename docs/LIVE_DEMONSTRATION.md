...
**File**:
`examples/demonstration_grok_2026-01-01.cp`
...
1. Starting a clean session with any modern LLM
2. Asking for an objective analysis of the ContinuumPort repository
3. Delaying identity disclosure
4. Explicitly querying memory and continuity
5. Requesting a CP-Core snapshot
...
ContinuumPort does not invent this behavior.
It **formalizes it**.
