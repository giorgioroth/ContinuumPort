...
[![Spec Status](https://img.shields.io/badge/Spec-Draft-yellow)]([docs/specification.md](https://github.com/giorgioroth/ContinuumPort/blob/main/docs/SPECIFICATION.md))
